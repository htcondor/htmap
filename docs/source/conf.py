...
project = "HTMap"
copyright = (
    "2018-2020, HTCondor Team, Computer Sciences Department, University of Wisconsin-Madison, WI"
)
...
# Custom sidebar templates, must be a dictionary that tags document names
# to template names.
#
...
man_pages = [(master_doc, "htmap", "HTMap Documentation", [author], 1)]
