...
class ComponentError:
    ...
    def report(self) -> str:
        ...
        """
        lines = [
            f"  Start error report for component {self.component} of map {self.map.tag}  ".center(
                80, "="
            ),
        ...
        lines.append("")
        lines.append(
            f"  End error report for component {self.component} of map {self.map.tag}  ".center(
                80, "="
            )
        )
